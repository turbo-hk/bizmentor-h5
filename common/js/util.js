...
export const navigateTo = (path = '') => {
	uni.navigateTo({
		url: path,
		success: function(e) {
			console.log("navigateTo, success", e)
		},
		fail: function(e) {
			console.log("navigateTo ,fail", e)
		},
		complete: function(e) {
			console.log("navigateTo, complete", e)
 ...
 * 去首页
 */
export const toIndex = () => navigateTo("/pages/news/list");
...
export const toLogin = () => {
	...
	if(isWeiXinLogin() == true){
		...
		uni.clearStorageSync("href");
		uni.setStorageSync("href", window.location.href);
		navigateTo("/pages/home/login/wx-mp-login/wx-mp-login");
	}else{
		navigateTo("/pages/home/login/pwd-login/pwd-login");
	}
} ;
